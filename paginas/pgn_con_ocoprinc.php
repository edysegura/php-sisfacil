...
<?
	if(sizeof($_GET))
	{
		...
		if($p_ob_result = $v_ob_oco->getOco($_GET['ocoCod']))
		{
			if(mysql_num_rows($p_ob_result))
			{
				echo "<span class='top'>Código:</span> ";
				echo "<span class='bottom'>". $_GET['ocoCod'] ."</span><br /><br />";
				
				echo "<span class='top'>Login | Nome:</span><br />";
				echo "<span class='bottom'>". $v_ob_func->getLogin(mysql_result($p_ob_result,0,'oco_funccod')) ." | ". $v_ob_func->getNome(mysql_result($p_ob_result,0,'oco_funccod')) ."</span><br /><br />";
				
				echo "<span class='top'>Departamento:</span><br />";
				echo "<span class='bottom'>". $v_ob_dep->getDep(mysql_result($p_ob_result,0,'oco_funcdepcod')) ."</span><br /><br />";
